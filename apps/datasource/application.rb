...
module Datasource
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['DATASOURCE_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Datasource::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Datasource::Action is included
      ...
      # Configure the code that will yield each time Datasource::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Datasource::Assets::Helpers
      end
    end
